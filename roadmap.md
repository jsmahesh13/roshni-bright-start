...
- [x] Two-tier admin console (.lovable/plan.md)
  - [x] Migration: platform_owners, audit_log, archived_at/archived_by, username, helpers, RLS OR-in + readonly guard
  - [x] Create + confirm jsmahesh.iitb@gmail.com super_admin account
  - [x] admin.functions.ts (create school/admin/teacher, archive/restore, impersonation, username resolve)
  - [x] Admin console UI (/admin/*, /manage, ImpersonationBanner), username login in auth
  - [x] i18n en/hi/kn/mr for all new strings
  - [x] Tests: counts intact, cross-school negative, readonly-write rejected; publish
